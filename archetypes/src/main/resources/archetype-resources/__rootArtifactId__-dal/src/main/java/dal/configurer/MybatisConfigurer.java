package ${package}.dal.configurer;
...
public class MybatisConfigurer {
    ...
    public static final String BASE_PACKAGE = "${package}.dal";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
    ...
    public static final String MAPPER_INTERFACE_REFERENCE = BASE_PACKAGE + ".configurer.core.Mapper";//Mapper插件基础接口的完全限定名
