...
public class RestContext {
    ...
    private static final ThreadLocal<RestContext> LOCAL = ThreadLocal.withInitial(RestContext::new);
     ...
     * @param restContext
     */
    public static void setLocal(RestContext restContext) {
