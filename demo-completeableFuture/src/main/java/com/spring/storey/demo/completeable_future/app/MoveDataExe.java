...
public class MoveDataExe {
    ...
    private R<String> moveData(String appId) {
        ...
        StopWatch stopWatch = new StopWatch("moveData-"+appId);
        ...
        wsList.forEach(this::dataXMoveData);
        stopWatch.stop();

        stopWatch.start("transRow");
        wsList.forEach(this::transRow);
        stopWatch.stop();

        stopWatch.start("updateWsCount");
        wsList.forEach(this::updateWsCount);
        stopWatch.stop();
