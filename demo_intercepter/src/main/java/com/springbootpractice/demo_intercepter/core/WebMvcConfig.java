...
public class WebMvcConfig implements WebMvcConfigurer , InitializingBean {
    ...
    public RestResponse handleException(HttpServletRequest request,Exception e){
        Integer code = RestResponse.CodeDict.ERROR_CODE;
        String msg = null;
        String exceptionMsg="";
        if (e instanceof BaseException){
            ...
            code  = RestResponse.CodeDict.NOT_FOUND_CODE;
            msg  =  RestResponse.MsgDict.NOT_FOUND_MSG;
        }else{
        ...
        final RestContext restContext = RestContext.getInstance();
        log.error("\n===param_exception===\n===requestId==={}===\n===Url==={},\n===Msg==={}\n===useTime==={}\n===error===",
            ...
            if (item instanceof RequestResponseBodyMethodProcessor){
                return  new HandlerMethodReturnValueHandler(){
                    ...
                    public void handleReturnValue(Object returnValue, MethodParameter returnType, ModelAndViewContainer mavContainer, NativeWebRequest webRequest) throws Exception {
                        ...
                        final RestResponse restResponse = RestResponse.builder().code(RestResponse.CodeDict.SUCCESS_CODE)
                                .msg(RestResponse.MsgDict.SUCCESS_MSG)
                                .data(returnValue)
                                .build();
                        ...
                        log.info("\n===param_response===\n===requestId==={}\n===json==={}",RestContext.getInstance().getRequestId(), messageConverter.getObjectMapper().writeValueAsString(restResponse));
