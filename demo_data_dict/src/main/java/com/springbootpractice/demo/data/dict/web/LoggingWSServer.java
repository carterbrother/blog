...
import com.springbootpractice.demo.data.dict.config.MyEndpointConfigure;
    ...
    public void onOpen(Session session) {
        ...
        new Thread(() -> {
            ...
            while (sessionMap.get(session.getId()) != null) {
                ...
                try {
                    //日志文件路径，获取最新的
                    String filePath = dataXBasePath+ "/log/" + new SimpleDateFormat("yyyyMMdd").format(new Date()) + "/"+applicationName+".log";
