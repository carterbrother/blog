...
/**
 * 数据权限规则字典(DataRuleDict)表服务接口
 *
 * @author carter
 * @since 2020-02-14 22:01:30
 */
public interface DataRuleDictService {
     ...
     * @return 对象列表
     */
    List<DataRuleDict> queryAllByLimit(int offset, int limit);
     ...
     * @return 实例对象
     */
    DataRuleDict insert(DataRuleDict dataRuleDict);
     ...
     * @return 实例对象
     */
    DataRuleDict update(DataRuleDict dataRuleDict);
