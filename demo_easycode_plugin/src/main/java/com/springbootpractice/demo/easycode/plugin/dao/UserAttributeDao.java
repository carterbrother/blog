...
public interface UserAttributeDao {
     ...
     * @return 对象列表
     */
    List<UserAttribute> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<UserAttribute> queryAll(UserAttribute userAttribute);
